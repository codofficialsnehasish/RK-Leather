...
define("DBNAME",DBPREFIX.'rk_leather'); // Here the database name is 'dummy_myecommerce'
...
$config['csrf_exclude_uris'] = array(
                                    ...
                                    'admin/products/get_sub_p_category',
                                    'admin/products/get_sub_categories_by_id_p',
                                    'admin/services/get-subcategory',
                                    'admin/products/media-process',
									'admin/media/getLibrary',
                                    'contact-us/process',
