               ...
               <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane active p-3" id="home" role="tabpanel">
                           ...
                           <div class="mb-3">
                        <label class="form-label">Sub Perent Category</label>
                        <div>
                           <select class="form-select" name="subp_id" id="subp_id" aria-label="Default select example">
                              <option value="">None</option>
                              <?php foreach($subparentcategories as $subp):?>
                              <option value="<?= $subp->cat_id;?>" <?= $item->sub_prerent_cata_id==$subp->cat_id?'selected':'';?>><?= $subp->cat_name;?></option>
                           <?php endforeach;?>
                              </select>
                        </div>
                     </div>
