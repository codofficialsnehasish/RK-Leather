                  ...
                  <div class="tab-content">
                     <div class="tab-pane active p-3" id="home" role="tabpanel">
                        <div class="row">
                           ...
                           <div class="mb-3 col-md-3">
                              <label class="form-label">VAT<small>&nbsp;(Value-added tax)</small></label>
                           ...
                           <div class="row calculated_gst_container" style="display:<?= $item->gst_rate == 0 ? 'none' : ''; ?>">
                              <label for="example-text-input" class="col-sm-3 col-form-label">VAT Amount (<?= get_currency($this->payment_settings->default_product_currency); ?>):</label>
