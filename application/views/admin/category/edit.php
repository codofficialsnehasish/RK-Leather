            ...
            <div class="col-lg-9">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="mb-3">
                        <label class="form-label">Sub Parent Category</label>
                        <div>
                           <select class="form-select" name="sub_parent_id" aria-label="Default select example">
                              <option value="">None</option>
                              <?php foreach($sub_categories as $sub):?>
                              <option value="<?= $sub->cat_id?>" <?= $sub->cat_id==$item->sub_parent_id?'selected':'';?>><?= $sub->cat_name;?></option>
                              <?php endforeach;?>
                              </select>
                        </div>
                     </div>
            ...
            <?php $this->load->view('admin/partials/_edit-input-image');?>
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Show on Header</label>
                        <div class="form-check form-check-inline">
                     ...
                     <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Show on Home Category</label>
                        <div class="form-check form-check-inline">
                           <?php if(count_home_categories() < 3){ ?>
                           ...
                           <?php }else{ ?>
                              <b style="font-weight:700;color:red;"> Only three. </b>
                           <?php } ?>
                        </div>
                        <div class="form-check form-check-inline">
                      ...
                      <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Show on Shop Menu</label>
                        <div class="form-check form-check-inline">
