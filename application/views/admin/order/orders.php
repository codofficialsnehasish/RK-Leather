                                ...
                                <div class="dropdown">
                                           <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <?php if ($item->payment_status != 'payment_received'): ?>
                                                    ...
                                                    <div class="dropdown-divider"></div>
											<?php endif; ?>
                                                <a href="javascript:void(0)" class="dropdown-item" onclick="confirmDelete(this.id,'orders');" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove this Item" id="<?= $item->id;?>"> <i class="fas fa-trash-alt text-danger" title="Remove"></i> Delete
                                             </a>
                                            </div>
                                </div>
								<?php echo form_close(); ?>
