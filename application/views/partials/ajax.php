...
function updateCart(cartId,productId,qty){
  var a = { product_id: productId, cart_item_id: cartId, quantity: qty, csrf_modesy_token:getCookie('csrf_modesy_token') };
    $.ajax({
        type: "POST",
