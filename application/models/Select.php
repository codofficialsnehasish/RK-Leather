   ...
   {  
	...
	public function record_count_category($id) {
	 ...
	 public function select_table($table,$orderby="",$order="",$limit="", $offset="1000000")  
	  ...
	  function select_double_data($table,$field_id1,$id1,$field_id2,$id2,$orderby="",$order="",$limit="", $offset="10000000")
	  {
         $this->db->select('*');
		 $this->db->from($table);
		 $this->db->limit($offset, $limit);
	...
	/////////////////////////////////////////////////////////////
	  function username_exists($email)
		...
		public function get_sub_parent_categories()
		{
			$this->db->where('parent_id !=', 0);
			$this->db->where('is_visible', 1);
			$query = $this->db->get('categories');
		...
		public function get_sub_parent_categories_by_id($parent_id,$name)
		{
			$this->db->where('parent_id =', $parent_id);
			$this->db->where('sub_parent_id', 0);
		...
		public function get_sub_categories_by_id($sub_p_id,$name)
		{
			$this->db->where('sub_parent_id =', $sub_p_id);
			$this->db->where($name, 1);
			$this->db->where('is_visible', 1);
			$query = $this->db->get('categories');
			return $query->result();
